...
// up to the heading we're looking at
    ...
    var pov            = sv_pano.getPOV() 
    var yaw_tests      = [pov.yaw,sv_heading];
...
// Now iterate through the links...
  ...
  // moving to? (ie. within view?)
          ...
          debug_log("Yaw difference: " + yaw_difference + " heading tolerance: " + sv_heading_tolerance );
          if ( 
              yaw_difference              > sv_heading_tolerance 
              && ( 360 - yaw_difference ) > sv_heading_tolerance 
          ) {
              continue;
          }
